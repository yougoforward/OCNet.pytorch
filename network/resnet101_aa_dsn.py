...
from aa import topk_PAM_Module, SE_CAM_Module2, selective_aggregation_ASPP_Module2
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes):
        ...
        self.context = AANetHead(2048, num_classes, InPlaceABNSync)
        # extra added layers
...
def get_resnet101_aa_dsn(num_classes=21):
